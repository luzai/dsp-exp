...
DLL_IMP void vector_init(vector *);
DLL_IMP int vector_count(vector *);
DLL_IMP void vector_add(vector *, void *);
DLL_IMP void vector_set(vector *, int, void *);
DLL_IMP void *vector_get(vector *, int);
DLL_IMP void vector_delete(vector *, int);
DLL_IMP void vector_free(vector *);
}
